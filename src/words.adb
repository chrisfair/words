...
--     (C) Copyright 2015-05-08 by Christopher P. Fair
...
begin
   ...
   for I in 1 .. Argument_Count loop
	 ...
	 if I < Argument_Count then
         ...
         Put ("words: Unknown argument "); Put (Argument (I)); New_Line;
         Problems := True;
   ...
   if Version then
      Put_Line ("words Version 0.97");
   end if;

   if Help then
      Put_Line ("words [options] [files]");
   ...
   Put      ("This is words, and the GNU tools think the package is called ");
